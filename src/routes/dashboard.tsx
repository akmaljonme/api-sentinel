    ...
    <div className="mx-auto max-w-7xl p-6 lg:p-8 space-y-6">
      <div className="flex items-end justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="mt-1 text-[13px] text-text-secondary">Your APIs are being monitored live.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Stat icon={FileCode2} label="Active specs" value={String(metrics?.specCount ?? 0)} delta={`${specs.length} uploaded`} tone="primary" />
  ...
  return (
    <div className="rounded-2xl border border-dashed border-border bg-surface/40 p-12 text-center">
      ...
      <p className="mt-1.5 text-[13px] text-text-secondary max-w-md mx-auto">
        Drag and drop a YAML or JSON file. Flowt analyzes endpoints, spins up a live mock server, and tracks breaking changes.
      </p>
