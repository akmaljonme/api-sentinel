...
export const Route = createFileRoute("/drift/$id")({
  head: () => ({ meta: [{ title: "Drift report — Flowt" }, { name: "description", content: "Spec drift report and breaking changes history." }] }),
  component: DriftPage,
});
      ...
      <div className="mx-auto max-w-7xl p-6 lg:p-8 space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="mt-1 text-[13px] text-text-secondary">Compare spec versions to identify breaking changes before shipping.</p>
          </div>
        ...
        {showCompare && (
          <div className="rounded-xl border border-border bg-surface p-5 space-y-3">
            ...
            <textarea value={newContent} onChange={(e) => setNewContent(e.target.value)} spellCheck={false}
              placeholder="…or paste a new spec version"
